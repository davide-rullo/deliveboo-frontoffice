    ...
    <div class="container py-5">
      ...
      <div class="d-flex justify-content-center gap-4 mb-5 flex-wrap">
        ...
        <div class="d-flex mb-3">
          <div
            class="types card bg-transparent border-0"
      ...
      <div class="py-4">
        <nav aria-label="Page navigation">
          <ul class="pagination justify-content-center my-4">
            <li class="page-item" v-for="link in links" :class="link.active ? 'active' : ''" :key="link.label">
              <a
                class="page-link text-danger border-0"
                role="button"
                aria-label="Page {{ link.label }}"
                v-html="link.label"
                @click="getRestaurants(link.url)"
              ></a>
            </li>
          </ul>
        </nav>
